...
await ctx.addInitScript(() => { for (const k of ["wm_ofTpoProfile","wm_ofProfileMemory","wm_ofProfileFusion","wm_ofValueMigration","wm_ofCompositeProfile","wm_absorptionAnatomy"]) localStorage.setItem(k, "false"); localStorage.setItem("wm_ofLivingProfile","true"); localStorage.setItem("wm_ofMemoryGhost","true"); });
