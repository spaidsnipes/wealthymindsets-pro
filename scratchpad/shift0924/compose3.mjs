...
const [,, plate, runtime, detail, out, title, detailLabel] = process.argv;
const H = 1000;
...
<text x="16" y="27" font-family="sans-serif" font-size="16" font-weight="700" fill="#c9a55c">${esc(detailLabel ?? "DETAIL · the same runtime frame, shot at 2× device pixels (no retouching)")}</text></svg>`;
