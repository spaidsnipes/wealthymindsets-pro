...
for (const d of ["CARDS"]) {
  await p.evaluate(v => { localStorage.setItem("wm_ofAnatomyCards", "false"); localStorage.setItem("wm_ofQuestionLens", "true"); localStorage.setItem("wm_ofAnatomyCards", "true"); localStorage.setItem("wm_ofScaffolding", "\"FOUNDATION\""); }, d);
  ...
  await p.screenshot({ path: `scratchpad/shift0924/runtime_combo1366_${d}.png` });
}
