...
await p.locator('[data-testid="stack-pick-LIVING"]').click(); await p.locator('[data-testid="stack-pick-VISIBLE_RANGE"]').click();
...
await p.screenshot({ path: "scratchpad/shift0924/fusion_living_panel.png" });
...
await p.screenshot({ path: "scratchpad/shift0924/fusion_living_after.png" });
