...
for (const d of ["CARDS"]) {
  await p.evaluate(v => { localStorage.setItem("wm_ofAnatomyCards", "false"); localStorage.setItem("wm_ofQuestionLens", "false"); localStorage.setItem("wm_ofRegimeLighting", "true"); localStorage.setItem("wm_ofScaffolding", "\"OFF\""); }, d);
  ...
  await p.screenshot({ path: `scratchpad/shift0924/runtime_regime_${d}.png` });
}
