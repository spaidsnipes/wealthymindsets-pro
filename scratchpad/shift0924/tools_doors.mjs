...
await p.screenshot({ path: "scratchpad/shift0924/tools_menu.png" });
...
await p.screenshot({ path: "scratchpad/shift0924/tools_orderflow.png" });
...
await p.screenshot({ path: "scratchpad/shift0924/tools_orderflow_after.png" });
...
await p.screenshot({ path: "scratchpad/shift0924/tools_charttools.png" });
