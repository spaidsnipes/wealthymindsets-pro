...
console.log("NEAR", JSON.stringify(await p.evaluate(() => { const c = [...document.querySelectorAll("canvas")].find(c => c.dataset.nearBarDelta !== undefined); return { nearBarDelta: c?.dataset.nearBarDelta, zoom: c?.dataset.semanticZoom }; })));
