...
const read = () => p.evaluate(() => { const c = [...document.querySelectorAll("canvas")].find(c => c.dataset.absorptionDepthForm !== undefined); return { form: c?.dataset.absorptionDepthForm, density: c?.dataset.semanticDensity }; });
