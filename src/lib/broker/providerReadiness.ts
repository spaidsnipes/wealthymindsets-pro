...
export const PROVIDER_REQUIREMENTS: readonly ProviderRequirement[] = [
  {
    ...
    lane: "market-data",
    required: ["WEBULL_API_KEY", "WEBULL_API_SECRET", "WEBULL_API_HOST"],
    recommended: ["WEBULL_DATA_URL", "WEBULL_CANARY_SYMBOL"],
    note: "Signed tick reads. Without WEBULL_API_HOST there is no endpoint to authenticate against, so no signed tick can be earned.",
  },
  {
    provider: "webull-broker",
    label: "Webull broker execution",
    lane: "broker",
    required: ["WEBULL_API_KEY", "WEBULL_API_SECRET", "WEBULL_API_HOST", "WEBULL_CLIENT_ID"],
    recommended: [],
