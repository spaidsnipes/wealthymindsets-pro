 ...
 *
 * A time-based guard is the right tool here because the ticket submit is a
 * synchronous local write with no network round trip to disable against. Two clicks
