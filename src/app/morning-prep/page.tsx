  ...
  return (
    ...
    >
      ...
      <div className="max-w-3xl mx-auto px-6 py-6 space-y-4">
        ...
        {/* No WM Playbook card wall here (2026-09-24). The notes are framework
            placeholders, identical every day, and teaching belongs behind the
            Academy door — not stacked as gold paragraphs in a room whose job is
            preparation. */}
